...
public class Test5 {
	public static void main(String[] args) { 
		  ...
		  spec.find.input().with.id("currentP").set("http://www.nickutopia.com/wp-content/uploads/2011/09/All-That-e1316802801807.gif");
		  spec.find.input().with.name("Newpic").set("http://upload.wikimedia.org/wikipedia/en/2/27/Kenan_%26_Kel_intertitle.jpg");
		  spec.pause(2000).find.input().with.name("edPic").click();
